...
//http://telerikacademy.com/Courses/LectureResources/Video/5466/Exam-preparation-Telerik-Logo-Spiral-%d0%98%d0%b2%d0%b0%d0%b9%d0%bb%d0%be

namespace _10.Spiral
{
   class Spiral
   {
      static void Main()
      {
         ...
         //fills up the matrix
         for (int i = 1; i <= N * N; i++) //for (int i = 100; i >=0 ; i--) 
         {
